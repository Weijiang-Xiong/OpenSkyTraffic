...
def default_argument_parser():
    ...
    parser.add_argument('--global_scale_low', type=float, default=0.35, help='Lower bound for global scale')
    parser.add_argument('--global_scale_high', type=float, default=0.7, help='Upper bound for global scale')
