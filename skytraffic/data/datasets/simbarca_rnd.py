...
class SimBarcaRandomObservation(SimBarcaMSMT):
    ...
    def prepare_data_for_prediction(self):
        ...
        if self.split == "train":
            # corrupted data for training
            self.pred_speed = vdist_3min / vtime_3min
...
class SimBarcaRandomObservationLegacy(SimBarca):
    ...
    @property
    def ld_mask_file(self):
        return "{}/processed/old_masks/ld_mask_{}.pkl".format(self.data_root, int(self.ld_cvg * 100))

    @property
    def drone_mask_file(self):
        return "{}/processed/old_masks/drone_mask_{}_{}.pkl".format(self.data_root, int(self.drone_cvg*100), self.split)
